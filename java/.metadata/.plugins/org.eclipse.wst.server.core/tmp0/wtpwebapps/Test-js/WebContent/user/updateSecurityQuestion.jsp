...
<link rel="stylesheet"
	href="${ pageContext.request.contextPath }/css/updatesecurityquestion.css">
<script
		...
		<div class="row">
			<div class="col-md-6 col-md-offset-3">
				<form action="${ pageContext.request.contextPath }/user"
					method="POST" role="form" class="updatesecurityquestion-form">
					<legend>
						<h1>修改密保问题</h1>
					</legend>
					<input type="hidden" name="action" value="updateSecurityQuestion">
					<input type="hidden" name="id" value="${ securityQuestion.id }">

					<div class="form-group">
						<label for="">问题</label> <input type="text" class="form-control"
							name="question" placeholder="请输入问题"
							value="${ securityQuestion.question }" required>
					</div>

					<div class="form-group">
						<label for="">答案</label> <input type="text" class="form-control"
							name="answer" placeholder="请输入答案"
							value="${ securityQuestion.answer }" required>
					</div>
