                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-danger" href="${ pageContext.request.contextPath }/account?action=deleteAccount&id=${ account.id }" role="button">删除</a>
                            <a class="btn btn-success" href="${ pageContext.request.contextPath }/account?action=updateAccountUI&id=${ account.id }" role="button">更新</a>
                        </div>
                    </div>
                </div>
            </div>
